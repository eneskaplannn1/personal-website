...
function Home() {
  ...
  return (
    <motion.main
      ...
      id="home"
    >
      <div className="flex max-w-lg lg:pt-52 px-2 mx-auto gap-y-16 md:max-w-3xl flex-col-reverse lg:max-w-[950px] lg:ml-24 xl:max-w-[1300px] lg:mx-auto py-20 lg:grid lg:grid-cols-[2fr,1fr] xxl:mx-auto xxl:max-w-[1500px]">
